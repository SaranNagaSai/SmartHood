                ...
                <form onSubmit={handleSubmit} className="profile-form">
                    ...
                    >
                        ...
                        <div className="input-with-voice">
                            <input name="name" value={user?.name || ''} onChange={(e) => handleChange("name", e.target.value)} />
                            <button type="button" onClick={isNameListening ? stopNameListening : startNameListening} className={`mic-icon-btn ${isNameListening ? 'active' : ''}`}><FaMicrophone /></button>
                        </div>
                    </motion.div>
                    ...
                    <div className="form-row">
                        ...
                        <div className="form-group">
                            ...
                            <input name="city" value={user?.city || ''} onChange={(e) => handleChange("city", e.target.value)} />
                        </div>
                    </div>

                    {/* Locality Change Warning */}
                    {showLocalityWarning && (
                        <motion.div
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p>Changing your locality will update your feed, notifications, and community scope.</p>
                            </div>
                        </motion.div>
                    )}
                    ...
                    <div className="form-group">
                        ...
                        <div className="input-with-voice">
                            <input name="profession" value={user?.profession || ''} onChange={(e) => handleChange("profession", e.target.value)} />
                            <button type="button" onClick={isProfessionListening ? stopProfessionListening : startProfessionListening} className={`mic-icon-btn ${isProfessionListening ? 'active' : ''}`}><FaMicrophone /></button>
                        </div>
                    </div>

                    <div className="form-group">
                        <label><FaLanguage /> {t("preferred_language")}</label>
                        <select name="preferredLanguage" value={user?.preferredLanguage} onChange={(e) => handleChange("preferredLanguage", e.target.value)}>
